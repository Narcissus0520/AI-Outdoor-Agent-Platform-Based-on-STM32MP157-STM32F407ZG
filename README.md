...
当前本机 10/10 CTest、连续 dashboard 一秒受控运行、storage/history/compass 组合验证和 ARMv7 hard-float 交叉构建已通过。真实 MP157 也已完成 60 秒多设备/SD history 冒烟、修复后 20 秒 framebuffer history 频率复验和 30 秒 1 MiB 日志轮转复验；小时级与掉电验证仍待执行。
